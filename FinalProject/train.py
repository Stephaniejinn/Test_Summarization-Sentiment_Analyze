...
def training(path):
    ...
    for file in files:
        train_x, train_y = build_dataset("train1", word_dict, article_max_len, summary_max_len, file)
...
training("NewsContents/")

# train_x, train_y = build_dataset("train1", word_dict, article_max_len, summary_max_len)
#
#
# with tf.Session() as sess:
#     model = Model(reversed_dict, article_max_len, summary_max_len, args)
